...
class FileSorter:
    ...
    def merge(self):
        ...
        tape2_runs_counter, tape3_runs_counter = 1, 1

        while True:
            # Already saved record is marked as None.
            ...
            if tape2_record is not None and tape2_last_record > tape2_record:
                tape2_runs_counter += 1
                tape2_last_record = None  # to avoid incrementing counter in the next iteration under the same condition

            if tape3_record is not None and tape3_last_record > tape3_record:
